...
async def test_250_admin_user_lifecycle(server_url, admin_auth_token):
    ...
    async with httpx.AsyncClient() as client:
        ...
        assert created_user["group"] == "users", "User should not have admin privileges"
        ...
        assert user_profile["group"] == "users", "User should not have admin privileges"
        ...
        resp = await client.delete(
            f"{server_url}/api/v1/admin/user/{test_username}",
            headers=admin_headers
        )
